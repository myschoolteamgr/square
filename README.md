...
> Άνοιγμα αυτής της σελίδας στο [https://myschoolteamgr.github.io/square/](https://myschoolteamgr.github.io/square/)
...
* αναζήτηση για **https://github.com/myschoolteamgr/square** και εισαγωγή
...
* επικολλήστε **https://github.com/myschoolteamgr/square** και κάντε κλικ στην εισαγωγή
